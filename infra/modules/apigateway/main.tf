  ...
  policy = jsonencode({
    ...
    Statement = [
      ...
      },
      {
        ...
        Effect   = "Allow"
        Resource = "arn:aws:logs:us-east-1:677276078111:log-group:/aws/api-gateway/*"
      },
      {
        Action   = "logs:PutLogEvents"
        Effect   = "Allow"
        Resource = "arn:aws:logs:us-east-1:677276078111:log-group:/aws/api-gateway/*:log-stream:*"
      }
    ]
  })
}
